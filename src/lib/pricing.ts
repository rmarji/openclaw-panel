...
export const tiers: PricingTier[] = [
  {
    name: "Starter",
    slug: "starter",
    description: "One agent. One channel. Everything you need to stop doing busywork yourself.",
    monthlyPrice: 29,
    yearlyPrice: 290,
    features: [
      "1 AI Agent instance",
  ...
  },
  {
    name: "Pro",
    slug: "pro",
    description: "Three agents across all your tools. This is where most teams start.",
    monthlyPrice: 79,
    yearlyPrice: 790,
    highlighted: true,
    features: [
  ...
  },
  {
    name: "Team",
    slug: "team",
    description: "Full control. Full observability. Your agents, your infrastructure, your rules.",
    monthlyPrice: 199,
    yearlyPrice: 1990,
    features: [
